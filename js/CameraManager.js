...
function SetupCameras(scene) {
    ...
    scene.onPointerDown = function (evt) {
        ...
        if (scene.activeCamera == walkerCam) {
            ...
            var pickInfo = scene.pick(scene.pointerX, scene.pointerY, function (mesh) { return (BABYLON.Tags.MatchesQuery(mesh, "arrow_coll") || 
                                                                                                BABYLON.Tags.MatchesQuery(mesh, "hs_coll") || 
                                                                                                BABYLON.Tags.MatchesQuery(mesh, "screen_link")) && 
                                                                                                mesh.isPickable; });
